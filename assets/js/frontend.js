...
(function($) {
    ...
    var TPDeposits = {
        ...
        handleCategoryClick: function(e) {
            ...
            // Filter packages (check if category is in space-separated list)
            ...
            if (category === 'all') {
                ...
                $cards.each(function() {
                    var $card = $(this);
                    var cardCategories = ($card.data('category') || '').split(' ');
            ...
            if (visibleCards === 0) {
                $grid.append('<p class="tp-no-treatments">' + (tpDeposits.i18n.noTreatments || 'No treatments found in this category.') + '</p>');
            }
        },
